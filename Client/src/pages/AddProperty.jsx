...
const AddProperty = () => {
  ...
  const validateForm = () => {
    ...
    if (propertyType === "home") {
      ...
      if (!homeProperties.balconies)
        errors.balconies = "Number of balconies is required";
      if (!homeProperties.bathrooms)
        errors.bathrooms = "Number of bathrooms is required";
      if (!homeProperties.garages)
        errors.garages = "Number of garages is required";
    }
  ...
  return (
    <div>
      ...
      <div className="flex flex-row-reverse gap-20">
          ...
          <div className="flex flex-wrap space-y-4">
            ...
            <div className="w-full">
              ...
              <Input
                ...
                type="text"
                onChange={(value) =>
                  setPropertyDetails({ ...propertyDetails, title: value })
                }
            ...
            <div className="w-full">
              <label className="block mb-2 text-gray-600">
                Set the Location by Dragging the Mark
              </label>
              <Map
                handleLatLng={handleLatLng}
                position={[propertyDetails.latitude, propertyDetails.longitude]}
                draggable={true}
              />
            </div>
          </div>
            ...
            <div>
              <div className="w-full">
                ...
                <Input
                  ...
                  type="number"
                  onChange={(value) =>
                    setHomeProperties({ ...homeProperties, rooms: value })
                  }
              ...
              <div className="w-full">
                ...
                <Input
                  ...
                  type="number"
                  onChange={(value) =>
                    setHomeProperties({ ...homeProperties, balconies: value })
                  }
              ...
              <div className="w-full">
                ...
                <Input
                  ...
                  type="number"
                  onChange={(value) =>
                    setHomeProperties({ ...homeProperties, bathrooms: value })
                  }
              ...
              <div className="w-full">
                ...
                <Input
                  ...
                  type="number"
                  onChange={(value) =>
                    setHomeProperties({ ...homeProperties, garages: value })
                  }
        ...
        {showModal && (
          <Modal message="Property Added Successfuly" onClose={closeModal} />
        )}
      </div>
    </div>
  );
